      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-10 table-container">
            <h2 class="text-center mb-4">Volunteers List</h2>
            <?php
              include '../db.php';
              ...
              while ($row = $result->fetch_assoc()) {
                echo "<tr><td>{$row['volunteer_id']}</td><td>{$row['name']}</td><td>{$row['email']}</td><td>{$row['notes']}</td></tr>";
              }
              echo "</tbody></table>";
            ?>
          </div>
            ...
            <div class="card shadow-sm border-0">
              ...
              <div class="card-body">
                <p class="mb-0" style="font-size: 1.05rem;">
                  This table lists all volunteers participating in the BMCC Healthy Food Deficit Project. Each record includes the volunteer's contact information and additional notes to help staff coordinate meal preparation and student support more effectively.
                </p>
              </div>
            </div>
          </div>
